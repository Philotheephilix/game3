...
const worldSystemContract = manifest.contracts.find((contract) => contract.tag === 'di-world_system');
const gameSystemContract = manifest.contracts.find((contract) => contract.tag === 'di-game_system');
